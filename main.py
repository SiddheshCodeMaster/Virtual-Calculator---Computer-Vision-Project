...
class Button:
    ...
    def checkClick(self,x,y):
        if self.pos[0] < x < self.pos[0] + self.width and \
            ...
            cv2.rectangle(img,self.pos,(self.pos[0] + self.width,self.pos[1] + self.height),
                (50,50,50), 3)
            cv2.putText(img,self.value,(self.pos[0] + 40,self.pos[1] + 60), cv2.FONT_HERSHEY_PLAIN,2,(0,0,0),4)
...
# We want only one hand not multiple hands.
# We want it to detect a hand only when it is 80% sure.
